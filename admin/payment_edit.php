  ...
  <div class="row justify-content-center">
    <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-10 col-sm-12 col-xs-12">
      <div class="bg-white rounded-top my-2">
        ...
        <div class="p-2">
          <div id="bank-state" data-state="<?php echo $payment['bank'] ?>">
          ...
          <div class="my-2">
            ...
            <input type="text" value="<?php echo $payment['account_name'] ?>" class="form-control" id="bank-account-name" placeholder="ป้อนชื่อบัญขี">
          </div>
          <div class="my-2">
            <label class="form-label">
              หมายเลขบัญชี
            </label>
            <input type="text" value="<?php echo $payment['account_number'] ?>" class="form-control" id="bank-number" placeholder="ป้อนหมายเลขบัญชี">
          </div>
          <button id="paymentSubmit" class="btn btn-primary" data-id="<?php echo $payment['payment_id'] ?>">
            บันทึก
          </button>
        </div>
      </div>
...
<script src="./js/payment_edit.js"></script>